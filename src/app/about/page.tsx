    ...
    <section className="container flex flex-col items-center gap-10 py-12">
      ...
      <div className="w-full max-w-2xl rounded-lg border bg-card text-card-foreground shadow-sm p-8">
        ...
        <p className="text-muted-foreground mb-4">
          I&apos;ve led the development of business-grade component libraries (F
          UI, T UI, UF Components), built design systems from the ground up, and
        ...
        <p className="text-muted-foreground mb-4">
          ...
          remote collaboration efficiency. Based in a small town in China,
          I&apos;m a disciplined remote worker with years of experience
          delivering across time zones and cultures.
        </p>
        <div className="pt-2 border-t text-muted-foreground text-sm">
          ...
          <div>
            💬 Let&apos;s connect if you&apos;re hiring or want to talk about
            design systems, frontend architecture, or remote team culture.
          </div>
        </div>
      </div>
    </section>
