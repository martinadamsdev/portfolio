...
const _themeOrder = ["light", "dark"] as const;
...
export function ModeToggle() {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait" initial={false}>
        {current === "light" ? (
          ...
          >
            ...
            >
              <span
                className="icon-[ph--sun] w-5 h-5 text-yellow-500"
                aria-hidden="true"
              />
            </motion.div>
          ...
          >
            ...
            >
              <span
                className="icon-[ph--moon] w-5 h-5 text-blue-400"
                aria-hidden="true"
              />
            </motion.div>
      ...
      <div className="absolute inset-0 rounded-md pointer-events-none transition-all duration-200 group-hover:ring-2 group-hover:ring-primary/30" />
    </Button>
  );
}
